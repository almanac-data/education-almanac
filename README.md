...
[![CI](https://github.com/almanac-data/education-almanac/actions/workflows/ci.yml/badge.svg)](https://github.com/almanac-data/education-almanac/actions/workflows/ci.yml)
[![good first issues](https://img.shields.io/github/issues/almanac-data/education-almanac/good%20first%20issue?label=good%20first%20issues&color=7057ff)](https://github.com/almanac-data/education-almanac/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first%20issue%22)

**An open, versioned index of public education data — so the record stays findable when the websites move.**

Education Almanac is a **catalog, not a data warehouse**. Each entry is a small, human-reviewed,
...
It covers data from publishers like NCES, state education agencies, and federal surveys on schools, students, and outcomes.
